"""
@Author: TUSHAR SINGH
@Tpoic: Car-Number-Plate-Detection using the Haar Cascade
@References: https://docs.opencv.org/3.4/db/d28/tutorial_cascade_classifier.html
@GitHub: https://github.com/SINGHxTUSHAR
@ Uses the Amazon-Q and AWS Services to help in the code and optimization.
@ Also uses the https://stackoverflow.com/ to resolve the queries and error.
"""

import cv2

# Path to the Haar Cascade classifier XML file for license plate detection
# harcascade = "C:\Users\dell\Downloads\Car-Number-Plates-Detection-main\model\haarcascade_russian_plate_number.xml"
harcascade = "C:/Users/dell/Downloads/Car-Number-Plates-Detection-main/model/haarcascade_russian_plate_number.xml"
